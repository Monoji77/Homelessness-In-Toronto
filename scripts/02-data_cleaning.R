...
#                       other factors could affect the capacity of the area. However, we cannot
#                       drop values from capacity_service_room and capacity_service_bed. If
#                       capacity_service_room has a value, then capacity_service_bed will be NA
#                       vice-versa.
#
# NOTE: by dropping values, we lost approximately 2.9% of information.

cleaned_data <- intermediate_data |>
  drop_na(location_city, program_area)
